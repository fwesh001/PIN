/**
 * Inline SVG icon components for the NJPST design system.
 *
 * All icons are monochromatic, styled via currentColor so they inherit
 * the parent's text colour.  Default size is 1rem (16 × 16) with a
...
export function ScalesIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M5 12a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3" />
      <path d="M12 7l-3 5h6l-3-5z" />
    </svg>
  );
}

/** ID Badge / Document — replaces 🆔 */
export function IdBadgeIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
/** File / Document — replaces 📄 */
export function FileIcon({ className = 'w-4 h-4', strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
/** Inbox / Mailbox — replaces 📭 */
export function InboxIcon({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
/** Cross / X mark — replaces ❌ */
export function CrossIcon({ className = 'w-3.5 h-3.5' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
